...
--Find any client ending with LLC
SELECT *
FROM client
WHERE client_name LIKE '%LLC';

--Find any supplier name ...Label...
SELECT *
...
SELECT client_name, clent.branch_id
FROM client
UNION
SELECT supplier_name, branch_suppliers.branch_id
...
--Find all clients who are handled by the branch that Michael Scott manager
...
CREATE
    ...
    ON employee
    FOR EACH ROW BEGIN
      INSERT INTO trigger_test VALUES ('added new epmloyee'); (NEW.first_name)
    END $$
DELIMITER;

INSERT INTO employee
VALUES (109, 'Oscar', 'Martinez', '1980-02-19', 'M', 69000, 106, 3);

INSERT INTO employee
VALUES (110, 'Igor', 'Ivanov', '1980-02-19', 'M', 64000, 106, 2);
...
CREATE
    ...
    FOR EACH ROW BEGIN
        ...
        ELSE 
            INSERT INTO trigger_test VALUE('added other employee');
        END IF;
END$$